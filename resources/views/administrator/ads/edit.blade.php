...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue" style="display: block;">Cập nhật quảng cáo</h3><i>(Ảnh quảng cáo, đối tác)</i>
        <div class="widget">
            <form class="form-horizontal" role="form">
            <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Kiểu banner:<span class="req">*</span> </label>
                <div class="col-sm-2">
            ...
            <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Tên quảng cáo:<span class="req">*</span> </label>
                <div class="col-sm-10">
            ...
            <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Link banner:<span class="req">*</span> </label>
                <div class="col-sm-10">
                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control" />
                </div>
            </div>
              <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Link flash:<span class="req">*</span> </label>
                <div class="col-sm-10">
                    <input type="text" id="form-field-1-1" placeholder="Text Field" class="form-control" />
                </div>
            </div>
