...
<div class="row">
   <div class="col-xs-12">
      <h3 class="header smaller lighter blue" style="display: block;">Quản lý sản phẩm</h3>
      <div class="clearfix" style="display: block;">
         <div class="pull-left" style="margin-bottom: 10px;">
            <a class="btn btn-info" href="{{ URL::to('administrator/product/add') }}"><strong>Đăng sản phẩm</strong> &nbsp;&nbsp;<i class="ace-icon glyphicon glyphicon-plus"></i></a>
         </div>
      ...
      <div>
         <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
               ...
               <tbody>
               @if ($oListProducts)
                 @foreach ($oListProducts as $oListProduct)
                      <tr>
                     <td class="center">
                        <label class="pos-rel">
                        <input type="checkbox" class="ace" />
                     ...
                     <td>
                        <a href="#">{!! $oListProduct->pro_name !!}</a>
                     </td>
                     <td>
                        @if ($oListProduct->image)
                          <img src="{!! asset('resources/upload/'.$oListProduct->image) !!}" width="30">
                        @endif
                     </td>
                     <td>{!! $oListProduct->name!!}</td>
                     <td class="hidden-480">{!! date('H:i:s d-m-Y', strtotime($oListProduct->created_at ))  !!}</td>
                     <td class="hidden-480">{!! date('H:i:s d-m-Y', strtotime($oListProduct->updated_at))!!}</td>

                     <td class="hidden-480">
                        @if ($oListProduct->pro_status == 1)
                          <a id="status" rel='{!! $oListProduct->id !!}' class="btn btn-primary btn-xs ace-icon glyphicon glyphicon-ok" ></a>
                        @else
                           <a id="status" rel='{!! $oListProduct->id !!}' class="btn btn-danger btn-xs ace-icon glyphicon glyphicon-remove"></a>
                        @endif
                     </td>
                     <td>
