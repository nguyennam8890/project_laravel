...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue" style="display: block;">Thêm mới tin tức</h3>
        <div class="widget">
            <form class="form-horizontal" role="form">
            <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Tiêu đề:<span class="req">*</span> </label>
                <div class="col-sm-10">
            ...
            <div class="formRow">
             ...
             <div class="formRow">
                <label class="col-sm-2 control-label no-padding-right text_left" for="form-field-1-1"> Nội dung:<span class="req">*</span> </label>
                <div class="col-sm-10">
                    <div class="control-group">
                        <textarea name="" id="input" class="form-control" rows="15" required="required"></textarea>
                    </div>
