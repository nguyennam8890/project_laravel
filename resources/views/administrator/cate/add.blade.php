...
<div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue" style="display: block;">Thêm mới danh mục</h3>
          <!-- Thông báo lỗi -->
              @include('administrator.block.error')
        <div class="widget">
            <form action="{!! route('administrator.cate.postAdd1') !!}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                ...
                <div class="formRow">
                    ...
                    <div class="col-sm-2">
                        <select class="form-control" name="parent_id" id="parent_id">
                            ...
                            <?php recursiveCategory($category_product,$parent = 0,$str='',$select=0,$type='cate'); ?>
                        </select>
                    </div>
                </div>
                <div class="formRow">
                ...
                <div class="formRow">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="banner_url" name="banner_url" class="form-control" value="{{ old('banner_url') }}"/>
                    </div>
                </div>
                <div class="formRow">
                    <label class="col-sm-2 control-label no-padding-right text_left" for="spinner1"> Thứ tự: </label>
                    <div class="col-sm-10">
                        <input type="text" id="spinner1" name="order" value="{{ old('order') }}"/>
                    </div>
                </div>
                <div class="formRow">
                    <label class="col-sm-2 control-label no-padding-right text_left" for="spinner1a"> Thứ tự trên trang chủ:</label>
                    <div class="col-sm-10">
                        <input type="text" id="spinner1a" name="ordering_index" value="{{ old('ordering_index') }}"/>
                    </div>
                </div>
                <div class="formRow">
...
/*var test = $('#status').prop('checked')  // Boolean true
alert(test);*/
    jQuery(function($) {
