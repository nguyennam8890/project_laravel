...
@section('content')
    <div class="row">
    <div class="col-xs-12">
        <h3 class="header smaller lighter blue" style="display: block;">Quản lý danh mục tin tức</h3>
        <div class="clearfix" style="display: block;">
        <div class="pull-left" style="margin-bottom: 10px;">
            <a class="btn btn-info" href="{{ URL::to('administrator/cate_news/add') }}"><strong>Thêm danh mục</strong> &nbsp;&nbsp;<i class="ace-icon glyphicon glyphicon-plus"></i></a>
        </div>
