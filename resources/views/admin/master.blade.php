                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('admin/cate/list') }}">List Category</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('admin/cate/add') }}">Add Category</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('admin/product/list') }}">List Product</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('admin/product/add') }}">Add Product</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ URL::to('admin/user/list') }}">List User</a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('admin/user/add') }}">Add User</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
