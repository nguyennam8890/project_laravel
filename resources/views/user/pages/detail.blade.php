...
@section('content')
  <section id="product">
    <div class="container">
      @include('user.blocks.breadcrumb')
      <!-- Product Details-->
      <div class="row">
       <!-- Left Image-->
        <div class="span5">
  ...
  <section id="related" class="row">
    <div class="container">
      ...
      @foreach ($product_cate as $item_product_cate)
          <li class="span3">
          <a class="prdocutname" href="{!! url('loai-san-pham',[$item_product_cate->id,$item_product_cate->alias]) !!}">{!! $item_product_cate->name !!}</a>
          <div class="thumbnail">
            <span class="sale tooltip-test">Sale</span>
            <a href="{!! url('loai-san-pham',[$item_product_cate->id,$item_product_cate->alias]) !!}"><img alt="" src="{!! asset('resources/upload/'.$item_product_cate->image) !!}"></a>
            <div class="pricetag">
