  ...
  <section id="product">
    ...
    <!--  breadcrumb -->  
      ...
      <div class="row">        
        <!-- Account Login-->
        <div class="span9">
          <div class="checkoutsteptitle down">Step 1 : Delivery Details<a class="modify">Modify</a>
          </div>
          ...
          <div class="checkoutsteptitle down">Step 2: Confirm Order<a class="modify">Modify</a>
          </div>
          <div class="checkoutstep" style="display: block;">
            <div class="cart-info">
